# Getting Started with bot_army_fitness

This guide walks you through setting up the Fitness Bot for local development.
...
This creates a release named `fitness_bot` that is deployed to `/opt/ergon/releases/fitness_bot/` on the server.
...
DATABASE_NAME=bot_army_fitness_dev
```
...
3. Extracts and deploys to `/opt/ergon/releases/fitness_bot/`
