defmodule BotArmyFitness.Repo.Migrations.AddTenantAndUserId do
  ...
  def up do
    ...
    if not Ecto.Migration.column_exists?(:workouts, :tenant_id) do
    ...
    if not Ecto.Migration.column_exists?(:goals, :tenant_id) do
      ...
      execute("UPDATE goals SET tenant_id = '#{default_tenant_id}'::uuid WHERE tenant_id IS NULL")
    end
  end
